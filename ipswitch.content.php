	...
	<div class="ipswitchcaption">
		...
		<div class="caption-ipswitch"><div class="title">Ipswitch</div>
		A Survival-Horror Browser MMO
		</div>
	</div>
	<div class="content">
	...
	<div class="content">
		At any rate, this is the basic navigation page.  From here, players interact with the world and each other.  Many features don't work yet, such as unloading weapons.  Many
		other features aren't even present, like interior locations, day/night cycles, etc.  I've also been changing central portions of the code over to more object-oriented formats,
		so a lot of content is either broken or malfunctioning.  Expect things to work very poorly over the next few months.
	</div>
	<div class="content">
	...
	<div class="heading"><a href="ogame/mapgenerator.experiment.php">Map Tests</a><br /></div>
	<div class="content">
		There are other "tech demo" pages that I've made to test logic and classes.  Currently they're focused on the random map generation technology, organization of the
		map layout, and ease of replication and location attribute management.
	</div>
